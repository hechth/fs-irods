...
git branch -M main
git remote add origin git@github.com:hechth/fs-irods
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/hechth/repositories/new](https://github.com/organizations/hechth/repositories/new)
and create a new repository named `fs-irods` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/hechth/fs-irods/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
